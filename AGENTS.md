...
## Repository map
- `biome-plugins/` — explain what lives here and when agents should edit it.
- `biome.jsonc/` — explain what lives here and when agents should edit it.
- `build.ts/` — explain what lives here and when agents should edit it.
- `bun-env.d.ts/` — explain what lives here and when agents should edit it.
- `bun.lock/` — explain what lives here and when agents should edit it.
- `bunfig.toml/` — explain what lives here and when agents should edit it.
- `CLAUDE.md/` — explain what lives here and when agents should edit it.
- `docker-compose.coolify.yml/` — explain what lives here and when agents should edit it.
